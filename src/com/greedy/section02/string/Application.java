...
public class Application {
	...
	public static void main(String[] args) {
		...
		/* compareTo() : 인자로 전달된 문자ㅕㅇㄹ과 사전 순으로 비교를 하여 
		 * 두 문자열이 같다면 0을 반환, 인자로 전달된 문자열보다 작으면 음수를,
		 * 크면 양수를 반환한다.
		 * 단, 이 메소드는 대ㅅ문자를 구분하여 비교한다.
		 * */
		String str2 = "java";
		String str3 = "java";
		String str4 = "JAVA";
...
//		System.out.println(ext);
		...
		/*lastIndexOf() : 문자열 탐색을 위에서부터 하고 처음 일치하는 위치의 인덱스 번호를 반환한다.
		 * 단, 일치하는 문자가 없는 경우 -1을 반환한다.
		 * */
...
//		String checkBlanck = null;
//		
//		System.out.println(checkBlanck != null && checkBlanck.isEmpty());
	}
